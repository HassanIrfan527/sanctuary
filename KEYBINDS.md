...
Super + Shift + HJKL → Move window left/down/up/right
...
Super + =            → Volume +5% (backup)
Super + -            → Volume -5% (backup)
Super + 0            → Toggle mute (backup)

## Brightness
Brightness Up key    → Brightness +5%
Brightness Down key  → Brightness -5%
...
CapsLock + HJKL      → Arrow keys (works everywhere)
